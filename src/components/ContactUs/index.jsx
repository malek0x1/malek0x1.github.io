...
const ContactUs = () => {
    ...
    return (
        <div id="contactus" className="contactUs container fix">
            ...
            <div className="contactUs_wrapper">
                <SectionTitle color="accent" classname="mb-8" title="Contact Me" />
                <p className="text-white mb-8">Feel free to contact Me with any questions</p>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="contactUs__wrapper__form">
                        {fields.map((field, index) => (
                            <Fragment key={index}>

                                <div className="contactUs__wrapper__form__small">
                                    {field.type !== 'textarea' ? (
                                        <input
                                ...
                                {errors[field.name] && (
                                    <span className="text-red-500 text-sm w-full text-start">{errors[field.name].message}</span>
                                )}
                            </Fragment>
                        ))}
                        <button
                            type="submit"
                            className="hover:opacity-80 items-center flex rounded-sm justify-center bg-white text-purple-800 py-3 px-6 text-xs flex-1 sm:px-12"
                        >
